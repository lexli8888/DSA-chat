...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        if (keyFile.exists()) {
            ...
            client = ChatClientFactory.CreateNewClient(userSetting.getKeyPair());
            UserInfo user = UserInfo.New(userSetting.getKeyPair().getPublic(), userSetting.getUsername(), userSetting.getFirstName(), userSetting.getLastName());
            client.register(user);
            contactList = client.getContactList(userSetting.getUsername(), userSetting.getKeyPair());
            chatList = client.getChatList(userSetting.getUsername(), userSetting.getKeyPair());
            initRootLayout();
            showChatOverview();
        } else {
            showStartupDialog();
